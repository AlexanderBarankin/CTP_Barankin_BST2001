...
// Класс, который хранить список всех URL-адресов для поиска, а также относительный "уровень" каждого из них
public class URLPool {
    private final HashMap<String, URLDepthPair> visited;
    private final LinkedList<URLDepthPair> pool;
